    ...
    <div class="center">
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
					<a class="nav-link" href="register.php"><span class="fa fa-user" aria-hidden="true"></span>注册</span></a>
				</li>
            </ul>
        </div>
    </div>
        ...
        <center>
            <article>
                ...
                <div id="contact_form">
                    ...
                    <form name="form1" id="ff" method="post" action="checkpwd.php">
                        <label>
                            <span>用户名:</span>
                        ...
                        <label>
                            ...
                            <!--<textarea name="code" id="message"></textarea>-->
                        </label>
